...
|------------|-------------|------------------------------|
| `import-gtp-programme` | `scripts/import-gtp-programme-to-sanity.ts` | `gtp2026Programme` (days/sessions; also seeds session modal “Hosted by” text—logo in Studio) |
...
| `seed-gtp-programme-subpages` | `scripts/seed-gtp-programme-subpages.ts` | Creates missing `gtp2026ProgrammeActivityPage` documents for Action Workshops, AI Thinkers Networking Breakfast, Excursion Trips, and Film Screening; intentionally refuses production |
