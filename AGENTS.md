...
| `seed-gtp-programme-subpages` | `scripts/seed-gtp-programme-subpages.ts` | Creates missing `gtp2026ProgrammeActivityPage` documents for Action Workshops, AI Thinkers Networking Breakfast, and Film Screening; intentionally refuses production |
