...
function buildDocument() {
  ...
  return {
    ...
    abstractSubmissionsClosed: d.abstractSubmissionsClosed,
    abstractSubmissionsClosedMessage: d.abstractSubmissionsClosedMessage,
    workshopTabLabel: d.workshopTabLabel,
    workshopDeadline: d.workshopDeadline,
    workshopSubmissionsClosed: d.workshopSubmissionsClosed,
    workshopSubmissionsClosedMessage: d.workshopSubmissionsClosedMessage,
